...
def nombres_validos(df: pd, primer_nombre, segundo_nombre, primer_apellido,
    ...
    df.loc[df['i'], segundo_nombre] = df[
        segundo_nombre] + " " + df[primer_apellido]
    ...
    df.loc[df['i'], primer_apellido] = df[
        primer_apellido] + " " + df[segundo_apellido]
    df.loc[df['i'], segundo_apellido] = ""
    df.drop(columns=['i'], inplace=True)
    # Reemplazar primer apellido por segundo apellido cuando
    ...
    cols_to_clean = [primer_nombre, primer_apellido,
    ...
    for col in cols_nombre:
        df['nombre_completo_'] = df[
            'nombre_completo_'] + " " + df[col].fillna("")
        # Concatenar nombres y apellidos no vacíos
