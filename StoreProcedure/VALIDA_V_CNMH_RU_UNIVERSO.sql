...
/****** Object:  StoredProcedure [dbo].[VALIDA_V_CNMH_RU_UNIVERSO]    Script Date: 3/11/2023 2:35:16 p. m. ******/
DROP PROCEDURE [dbo].[VALIDA_V_CNMH_RU_UNIVERSO]
GO
...
-- Description:	Realiza la consulta de las personas desaparecidas de la fuente V_CNMH_RU
-- =============================================
CREATE   PROCEDURE [dbo].[VALIDA_V_CNMH_RU_UNIVERSO]
WITH RECOMPILE 
AS
BEGIN
  SET NOCOUNT ON;
  IF OBJECT_ID('[dbo].[BD_CNMH_RU_VAL]', 'U') IS NOT NULL
    DROP TABLE [dbo].[BD_CNMH_RU_VAL]
