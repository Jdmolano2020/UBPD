...
def limpiar_nombre_completo(nombre_completo):
    ...
    preposiciones = ["DE", "DEL", "DE LAS", "DE LA", "DE LOS", "VAN", "LA",
                     "VIUDA DE", "VIUDA", "SAN", "DA"]
    ...
    while len(tokens) > 4:
        ...
        while k < len(tokens):
            if k == 1:
                # Concatena el elemento actual con el siguiente elemento y
                # almacena el resultado en la posición actual
