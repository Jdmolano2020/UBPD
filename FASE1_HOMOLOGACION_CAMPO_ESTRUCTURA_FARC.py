...
def homologar_farc (df : pd ):
    ...
    condiciones_bloque2 =(
    	...
    	(df['presunto_responsable'].str.contains("BLOQUE") & df['presunto_responsable'].str.contains("CARIBE"))
        )
    ...
    condiciones_bloque4 =(
        (
        	...
        	(df['presunto_responsable'].str.contains("VICTOR") & df['presunto_responsable'].str.contains("ALIRIO") & 
          df['presunto_responsable'].str.contains("SAAVEDRA")))        
        )
    ...
    condiciones_bloque5 =(
        (
        	...
        	df['presunto_responsable'].str.contains("SECRETARIADO"))
        )
